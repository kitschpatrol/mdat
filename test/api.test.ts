...
describe('mdat placeholder comment expansion', () => {
	...
	it('should not include meta tag when addMetaComment is false', async () => {
		const markdown = await fs.readFile('./test/assets/test-document.md', 'utf8')
		const expandedString = await expandString(
			markdown,
		...
		const result = expandedString.toString()
		expect(result).not.toContain('Warning: Content inside HTML comment blocks was generated by mdat')
		expect(result).toMatchSnapshot()
	})

	it('should accept custom string for addMetaComment', async () => {
		const markdown = await fs.readFile('./test/assets/test-document.md', 'utf8')
		const customMessage = 'CUSTOM WARNING: This file is auto-generated!'
		const expandedString = await expandString(
			markdown,
	...
	it('should accept multiline custom string for addMetaComment', async () => {
		const markdown = await fs.readFile('./test/assets/test-document.md', 'utf8')
		const customMessage = 'WARNING: Auto-generated content\nDo not edit manually\nContact team@example.com for changes'
		const expandedString = await expandString(
			markdown,
			{ addMetaComment: customMessage },
			'./test/assets/test-rules.ts',
