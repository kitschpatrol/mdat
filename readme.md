...
| `--meta`<br>`-m`    | Embed an extra comment at the top of the generated Markdown warning editors that certain sections of the document have been generated dynamically. Can be a `boolean` to enable/disable the default message, or a `string` to provide a custom message. |           |                                                                               |
...
- ###### `<!-- size-table { files: ["package.json", "readme.md"] } -->`
  ...
  | readme.md    | 60.4 kB  | 11.6 kB | 9.3 kB |
