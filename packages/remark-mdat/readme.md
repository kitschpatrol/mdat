<!--+ Warning: Content in HTML comment blocks generated by mdat on 2024-02-05 +-->

<!-- header -->

# remark-mdat

[![NPM Package](https://img.shields.io/npm/v/remark-mdat.svg)](https://npmjs.com/package/remark-mdat)
...
Mdat takes a placeholder comment in a Markdown file like this:

```md
<!-- title -->
```

And populates it with dynamic data. In this case, from `package.json`:
...
This library is ESM only and requires Node 16 or newer. It's designed to work with Remark 15.
